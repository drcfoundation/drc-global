...
export const STORY_OF_DRC: Record<Language, StoryOfDRC> = {
  ...
  zh: {
    title: "DRC的故事",
    contents: [
      '数字储备货币（DRC）旨在成为去中心化的数字价值储藏，其供应有限且通货膨胀率为零。它是在新冠病毒危机期间创建的，因为当时财政和货币政策暴露了目前金融体系中的严重漏洞。数字储备货币的概念是由专门从事银行业律师和投资专家创始人<a href="https://www.linkedin.com/in/maximnurov/" target="_blank" rel="noreferrer">马克西姆·努罗夫</a>（Maxim Nurov）提出的。',
